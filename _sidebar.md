...
- **入门**
  - [0. Claude Code 是什么？](docs/00-what-is-claude-code.md)

- **核心架构**
  - [1. 整体架构一览](docs/01-architecture-overview.md)
  - [2. 源码目录结构](docs/02-source-structure.md)
  - [3. 代理循环：AI 的心跳](docs/03-agentic-loop.md)
  - [4. 对话引擎深度解析](docs/04-query-engine.md)
  - [5. 上下文工程与压缩](docs/05-context-compression.md)
